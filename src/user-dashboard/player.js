...
export default class Player extends React.Component {
  ...
  render () {
    const select = (
      <div
        className='select' style={{ display: (this.props.selectedTrack === 'track' ? 'hide' : 'content') }}
    ...
    const imgPlaceHolder = (
      <div className='select'>
        <img
          src='https://www.logolynx.com/images/logolynx/63/63b7e09aff8bbe832d22c752c4bef080.jpeg'
          alt='NapsterCat'
        />
        <div className='text'>
